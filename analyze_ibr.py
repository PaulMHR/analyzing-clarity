#!python
# %matplotlib inline
# Code taken from https://scipy-cookbook.readthedocs.io/items/ApplyFIRFilter.html
...
fs, original_data = wf.read(sys.argv[1])
for track_i in range(len(original_data[0])):
